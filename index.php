	...
	*/
	...
	if( isset( $_POST[ 'submit' ] ) ) {
		...
		if( $_POST[ 'deviceType' ] == "iPhone" ) {
			$deviceType = "iPhone";
		} elseif( $_POST[ 'deviceType' ] == "iPod" ) {
			$deviceType = "iPod";
		} elseif( $_POST[ 'deviceType' ] == "iPad" ) {
			$deviceType = "iPad";
		} elseif( $_POST[ 'deviceType' ] == "AppleTV" ) {
			$deviceType = "AppleTV";
		} else {
		...
		if( count( $result ) > 0 ) {
			...
			die(
				"<center>Device identifier already added! (Force download starting.) <br><a href='"
				.$url
				."'>"
				.$url
				."</a></center>"
...
<p style="text-align:center;"><a href="https://github.com/1Conan/TSSSaver">TSS Savver</a> is licensed under
